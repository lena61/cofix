...
export class cofix__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class cofix extends ethereum.SmartContract {
  static bind(address: Address): cofix {
    return new cofix("cofix", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): cofix__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new cofix__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<cofix__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new cofix__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
